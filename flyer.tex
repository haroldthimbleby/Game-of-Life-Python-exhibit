...
\def\s{\hskip .3ex}
\def\dot#1{\includegraphics[width=0.5cm]{images/#1}}
\dot{blend1.png} \s
\dot{blend2.png} \s
\dot{blend3.png} \s
\dot{blend4.png} \s
...
Watch the video, download interesting links, and get the open source Python \hbox{program} I wrote to run the Game of Life at:\\
...
\vfill\noindent\framebox{\begin{minipage}{\linewidth}
\fontsize{10}{13}\selectfont
{Email me at \texttt{harold@thimbleby.net}, see the Wikipedia article \emph{Conway's Game of Life}, or my own site \texttt{https://www.harold.thimbleby.net/life} for lots more information.}\end{minipage}}
